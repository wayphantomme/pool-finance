...
export const VAULT_PROGRAM_ADDRESS =
  "AGMkTMHFaAXMgnA2cCcb5sy6y4YofXcTbjujaaCGHJ1Z" as Address<"AGMkTMHFaAXMgnA2cCcb5sy6y4YofXcTbjujaaCGHJ1Z">;
...
export type ParsedVaultInstruction<
  TProgram extends string = "AGMkTMHFaAXMgnA2cCcb5sy6y4YofXcTbjujaaCGHJ1Z",
> =
  | ({
